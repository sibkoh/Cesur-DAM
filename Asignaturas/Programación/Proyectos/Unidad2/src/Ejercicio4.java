...
public class Ejercicio4 {
	...
	public static void main(String[] args) {
		...
		do {
			...
			System.out.println(
					"\nIntroduce tu peso, (El peso debe ser igual o mayor a 30 kg y menor o igual a 300 kgr): ");
			...
			if (peso < 30 || peso > 300) {
				...
				do {
					...
					System.out.println(
							"\nIntroduce tu altura, (La altura debe estar comprendida entre 1.30 metros y 2 metros): ");
